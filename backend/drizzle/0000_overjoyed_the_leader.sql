...
CREATE TYPE "public"."activity_event_type" AS ENUM('clock_in', 'clock_out', 'zone_entry', 'zone_exit', 'firearm_taken', 'firearm_returned', 'chamber_clearance', 'cleaning');--> statement-breakpoint
CREATE TYPE "public"."audit_event_type" AS ENUM('qr_scan', 'facial_match', 'facial_fail', 'firearm_taken', 'firearm_returned', 'maintenance', 'override', 'admin_action', 'alert', 'clock_in', 'clock_out');--> statement-breakpoint
...
ALTER TABLE "activity_logs" ADD CONSTRAINT "activity_logs_guard_id_guards_id_fk" FOREIGN KEY ("guard_id") REFERENCES "public"."guards"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "activity_logs" ADD CONSTRAINT "activity_logs_system_user_id_system_users_id_fk" FOREIGN KEY ("system_user_id") REFERENCES "public"."system_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "activity_logs" ADD CONSTRAINT "activity_logs_zone_id_zones_id_fk" FOREIGN KEY ("zone_id") REFERENCES "public"."zones"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "activity_logs" ADD CONSTRAINT "activity_logs_firearm_id_firearms_id_fk" FOREIGN KEY ("firearm_id") REFERENCES "public"."firearms"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "activity_logs_guard_idx" ON "activity_logs" USING btree ("guard_id","timestamp");--> statement-breakpoint
CREATE INDEX "activity_logs_firearm_idx" ON "activity_logs" USING btree ("firearm_id","timestamp");--> statement-breakpoint
